...
using IdentityProvidert.Pages;
using IdentityProvidert.Pages.Admin.ApiScopes;
using IdentityProvidert.Pages.Admin.Clients;
using IdentityProvidert.Pages.Admin.IdentityScopes;
    ...
    internal static class HostingExtensions
    {
        ...
        public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            // this adds the necessary config for the simple admin/config pages
            {
                ...
                builder.Services.AddTransient<IdentityProvidert.Pages.Portal.ClientRepository>();
